"""Run all SCOUT and baseline scripts across multiple seeds for YCB Geo experiment."""

import os

os.environ.setdefault('SCOUT_EXPERIMENT', 'ycb_geo')

from utils.config import scout_configs, scout_no_decouple_configs, START_SEED, END_SEED

FOLDER_SUFFIX = '_ycb_geo'
SCOUT_EXPERIMENT = 'ycb_geo'
