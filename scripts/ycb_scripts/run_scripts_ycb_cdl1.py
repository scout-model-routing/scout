"""Run all SCOUT and baseline scripts across multiple seeds for YCB CDL1 experiment."""

import os

os.environ.setdefault('SCOUT_EXPERIMENT', 'ycb_cdl1')

from utils.config import scout_configs, scout_no_decouple_configs, START_SEED, END_SEED

FOLDER_SUFFIX = '_ycb_cdl1'
SCOUT_EXPERIMENT = 'ycb_cdl1'
...
def run_script_for_seed(seed, script_name, folder_suffix):
    ...
    cmd = (
        ...
        f" python scripts/{script_name}.py --seed {seed} --folder_suffix {folder_suffix}"
    )
