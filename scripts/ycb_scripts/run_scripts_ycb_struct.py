"""Run all SCOUT and baseline scripts across multiple seeds for YCB Struct experiment."""

import os

os.environ.setdefault('SCOUT_EXPERIMENT', 'ycb_struct')

from utils.config import scout_configs, scout_no_decouple_configs, START_SEED, END_SEED

FOLDER_SUFFIX = '_ycb_struct'
SCOUT_EXPERIMENT = 'ycb_struct'
