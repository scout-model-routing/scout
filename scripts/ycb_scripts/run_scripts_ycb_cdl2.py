"""Run all SCOUT and baseline scripts across multiple seeds for YCB CDL2 experiment."""

import os

os.environ.setdefault('SCOUT_EXPERIMENT', 'ycb_cdl2')

from utils.config import scout_configs, scout_no_decouple_configs, START_SEED, END_SEED

FOLDER_SUFFIX = '_ycb_cdl2'
SCOUT_EXPERIMENT = 'ycb_cdl2'
