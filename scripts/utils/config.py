...
EXPERIMENTS = {
    'gso': {
        ...
        'scout_configs': {'T': 1.0, 'beta': 0.7, 'lr': 1e-4, 'epochs': 10, 'alpha': 1e3},
        'scout_no_decouple_configs': {'T': 1.0, 'beta': 0.7, 'lr': 1e-4, 'epochs': 25, 'alpha': 1e3},
    },
    'ycb_dcd': {
        ...
        'scout_configs': {'T': 0.5, 'beta': 0.5, 'lr': 1e-4, 'epochs': 10, 'alpha': 1e3},
        'scout_no_decouple_configs': {'T': 0.5, 'beta': 0.5, 'lr': 1e-4, 'epochs': 25, 'alpha': 1e3},
    },
    'ycb_cdl2': {
        'data_path': os.path.join(_folder_path, 'data', 'ycb_data_huny_inst_trip_trel_cdl2.npz'),
        'results_folder': os.path.join(_folder_path, 'results', 'ycb'),
        'model_categories_path': os.path.join(_folder_path, 'data', 'model_categories_real_ycb.csv'),
        'scout_configs': {'T': 0.1, 'beta': 0.5, 'lr': 1e-4, 'epochs': 10, 'alpha': 1e3},
        'scout_no_decouple_configs': {'T': 0.1, 'beta': 0.5, 'lr': 1e-4, 'epochs': 25, 'alpha': 1e3},
    },
    'ycb_cdl1': {
        'data_path': os.path.join(_folder_path, 'data', 'ycb_data_huny_inst_trip_trel_cdl1.npz'),
        'results_folder': os.path.join(_folder_path, 'results', 'ycb'),
        'model_categories_path': os.path.join(_folder_path, 'data', 'model_categories_real_ycb.csv'),
        'scout_configs': {'T': 0.2, 'beta': 0.5, 'lr': 1e-4, 'epochs': 10, 'alpha': 1e3},
        'scout_no_decouple_configs': {'T': 0.2, 'beta': 0.5, 'lr': 1e-4, 'epochs': 25, 'alpha': 1e3},
    },
    'ycb_iou': {
        'data_path': os.path.join(_folder_path, 'data', 'ycb_data_huny_inst_trip_trel_iou.npz'),
        'results_folder': os.path.join(_folder_path, 'results', 'ycb'),
        'model_categories_path': os.path.join(_folder_path, 'data', 'model_categories_real_ycb.csv'),
        'scout_configs': {'T': 2.0, 'beta': 0.5, 'lr': 1e-4, 'epochs': 10, 'alpha': 1e3},
        'scout_no_decouple_configs': {'T': 2.0, 'beta': 0.5, 'lr': 1e-4, 'epochs': 25, 'alpha': 1e3},
    },
    'ycb_emd': {
        'data_path': os.path.join(_folder_path, 'data', 'ycb_data_huny_inst_trip_trel_emd.npz'),
        'results_folder': os.path.join(_folder_path, 'results', 'ycb'),
        'model_categories_path': os.path.join(_folder_path, 'data', 'model_categories_real_ycb.csv'),
        'scout_configs': {'T': 0.15, 'beta': 0.5, 'lr': 1e-4, 'epochs': 10, 'alpha': 1e3},
        'scout_no_decouple_configs': {'T': 0.15, 'beta': 0.5, 'lr': 1e-4, 'epochs': 25, 'alpha': 1e3},
    },
    'ycb_geo': {
