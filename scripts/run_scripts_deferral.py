"""Run all SCOUT and baseline scripts in deferral mode across multiple seeds."""
...
def run_script_for_seed(seed, script_name, folder_suffix):
    """Run a single script for a given seed in deferral mode.
